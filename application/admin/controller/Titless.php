...
use app\admin\model\Titless as TitlessModel;
use think\facade\Session;

// 模型控制器
class Titless extends Common{
     ...
     */
    public function Del(){
    	if(TitlessModel::destroy(input('id'))){
