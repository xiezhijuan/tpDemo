/*
 ...
 Source Schema         : host_ixlzj

 Target Server Type    : MySQL
 Target Server Version : 50553
 File Encoding         : 65001

 Date: 02/11/2019 09:09:57
*/
...
CREATE TABLE `ad`  (
  ...
  `title` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '广告名称',
  `as_id` tinyint(5) NOT NULL COMMENT '所属位置',
  `pic` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '广告图片URL',
  `url` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '广告链接',
  `addtime` int(11) NOT NULL COMMENT '添加时间',
  `sort` int(11) NOT NULL COMMENT '排序',
  `open` tinyint(2) NOT NULL COMMENT '1=审核  0=未审核',
  `content` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '广告内容',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `plug_ad_adtypeid`(`as_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 38 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '广告表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ad
-- ----------------------------
INSERT INTO `ad` VALUES (15, '简单、高效、简洁', 1, '/uploads/20190305/b3607f45c4f6cf56456edbe3ab096e1a.jpg', 'http://demo.cltphp.com', 1480909037, 1, 1, '虽然世界上有成千上万的建站系统，但CLTPHP会告诉你，真正高效的建站系统是什么样的。');
INSERT INTO `ad` VALUES (17, '集万千宠爱于一身', 1, '/uploads/20190305/959887756be1af9bcc1a78ca0565fc8d.jpg', 'http://demo.cltphp.com', 1481788850, 2, 1, 'CLTPHP采用了优美的layui框架，一面极简，一面丰盈。加上angular Js，让数据交互变得更为简洁直白。用最基础的代码，实现最强大的效果，让你欲罢不能！');
INSERT INTO `ad` VALUES (18, '精益求精', 1, '/uploads/20190305/b043970c33f6a88529b332b4c5d0727b.jpg', 'http://demo.cltphp.com', 1481788869, 3, 1, 'CLTPHP采用的ThinkPHP5为基础框架，从而使得CLTPHP的拓展性变的极为强大。从模型构造到栏目建立，再到前台展示，一气呵成，网站后台一条龙式操作，让小白用户能快速掌握CLTPHP管理系统的核心操作，让小白开发者能更好的理解CLTPHP的核心构建价值。');
INSERT INTO `ad` VALUES (36, '虚席以待', 5, '', 'http://show.cltphp.com', 1551769792, 50, 1, '');
...
CREATE TABLE `admin`  (
  ...
  `uid` varchar(120) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '微信openid',
...
INSERT INTO `admin` VALUES (11, 'cltphp', '2495caa2aa678121ccc248e530494639', 2, '123@qq.com', '', '15896589568', '127.0.0.1', 1535512393, '0', 1, '', NULL);
...
) ENGINE = MyISAM AUTO_INCREMENT = 10 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '广告分类' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of adsense
-- ----------------------------
INSERT INTO `adsense` VALUES (1, '【首页】顶部轮播', 1);
INSERT INTO `adsense` VALUES (5, '【内页】横幅', 1);
...
CREATE TABLE `article`  (
  ...
  `keywords` varchar(120) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `description` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '内容',
  `template` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `posid` tinyint(2) UNSIGNED NULL DEFAULT 0 COMMENT '推荐位',
  `status` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '1',
  `recommend` tinyint(1) UNSIGNED NOT NULL DEFAULT 0,
  `readgroup` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `readpoint` smallint(5) NOT NULL DEFAULT 0,
  `sort` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `hits` int(11) UNSIGNED NOT NULL DEFAULT 0,
  `createtime` int(11) UNSIGNED NOT NULL DEFAULT 0,
  `updatetime` int(11) UNSIGNED NOT NULL DEFAULT 0,
  `copyfrom` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'CLTPHP',
  `fromlink` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'http://www.cltphp.com/',
  `thumb` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `title_style` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
...
-- ----------------------------
INSERT INTO `article_tags` VALUES (1, 1, 45);
INSERT INTO `article_tags` VALUES (2, 2, 45);
INSERT INTO `article_tags` VALUES (3, 1, 36);
INSERT INTO `article_tags` VALUES (4, 3, 36);
INSERT INTO `article_tags` VALUES (5, 4, 36);
INSERT INTO `article_tags` VALUES (6, 5, 43);
INSERT INTO `article_tags` VALUES (7, 6, 40);
INSERT INTO `article_tags` VALUES (8, 7, 17);
INSERT INTO `article_tags` VALUES (9, 8, 17);
...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '管理员分组' ROW_FORMAT = Compact;
...
CREATE TABLE `auth_rule`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 282 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '权限节点' ROW_FORMAT = Dynamic;
...
INSERT INTO `auth_rule` VALUES (7, 'Category', '栏目管理', 1, 1, 0, 'icon-list', '', 0, 4, 1446535875, 1, 1);
INSERT INTO `auth_rule` VALUES (9, 'Category/index', '栏目列表', 1, 1, 0, '', '', 7, 0, 1446535750, 1, 1);
INSERT INTO `auth_rule` VALUES (13, 'Category/edit', '操作-修改', 1, 1, 0, '', '', 9, 3, 1446535750, 1, 0);
INSERT INTO `auth_rule` VALUES (14, 'Category/add', '操作-添加', 1, 1, 0, '', '', 9, 0, 1446535750, 1, 0);
...
INSERT INTO `auth_rule` VALUES (27, 'Users', '会员管理', 1, 1, 0, 'icon-user', '', 0, 5, 1447231507, 1, 1);
INSERT INTO `auth_rule` VALUES (28, 'Function', '网站功能', 1, 1, 0, 'icon-cog', '', 0, 6, 1447231590, 1, 1);
INSERT INTO `auth_rule` VALUES (29, 'Users/index', '会员列表', 1, 1, 0, '', '', 27, 10, 1447232085, 1, 1);
INSERT INTO `auth_rule` VALUES (31, 'Link/index', '友情链接', 1, 1, 0, '', '', 28, 2, 1447232183, 0, 1);
INSERT INTO `auth_rule` VALUES (32, 'Link/add', '操作-添加', 1, 1, 0, '', '', 31, 1, 1447639935, 0, 0);
INSERT INTO `auth_rule` VALUES (38, 'Users/userGroup', '会员组', 1, 1, 0, '', '', 27, 50, 1448413248, 1, 1);
INSERT INTO `auth_rule` VALUES (45, 'Ad/index', '广告管理', 1, 1, 0, '', '', 28, 3, 1450314297, 1, 1);
INSERT INTO `auth_rule` VALUES (46, 'Ad/type', '广告位管理', 1, 1, 0, '', '', 28, 4, 1450314324, 1, 1);
INSERT INTO `auth_rule` VALUES (48, 'Message/index', '留言管理', 1, 1, 0, '', '', 28, 1, 1451267354, 0, 1);
...
INSERT INTO `auth_rule` VALUES (236, 'Category/del', '操作-删除', 1, 1, 0, '', '', 9, 5, 1497424900, 0, 0);
...
INSERT INTO `auth_rule` VALUES (234, 'Category/insert', '操作-添存', 1, 1, 0, '', '', 9, 2, 1497424143, 0, 0);
...
INSERT INTO `auth_rule` VALUES (238, 'page/edit', '单页编辑', 1, 1, 0, '', '', 7, 2, 1497425142, 0, 0);
INSERT INTO `auth_rule` VALUES (237, 'Category/cOrder', '操作-排序', 1, 1, 0, '', '', 9, 6, 1497424979, 0, 0);
INSERT INTO `auth_rule` VALUES (161, 'Users/usersState', '操作-状态', 1, 1, 0, '', '', 29, 1, 1461550835, 1, 0);
INSERT INTO `auth_rule` VALUES (162, 'Users/delall', '操作-全部删除', 1, 1, 0, '', '', 29, 4, 1461550835, 1, 0);
INSERT INTO `auth_rule` VALUES (163, 'Users/edit', '操作-编辑', 1, 1, 0, '', '', 29, 2, 1461550835, 1, 0);
INSERT INTO `auth_rule` VALUES (164, 'Users/usersDel', '操作-删除', 1, 1, 0, '', '', 29, 3, 1461550835, 1, 0);
INSERT INTO `auth_rule` VALUES (247, 'Message/del', '操作-删除', 1, 1, 0, '', '', 48, 1, 1497427449, 0, 0);
INSERT INTO `auth_rule` VALUES (166, 'Users/groupOrder', '操作-排序', 1, 1, 0, '', '', 38, 50, 1461550835, 1, 0);
INSERT INTO `auth_rule` VALUES (167, 'Users/groupAdd', '操作-添加', 1, 1, 0, '', '', 38, 10, 1461550835, 1, 0);
INSERT INTO `auth_rule` VALUES (169, 'Users/groupDel', '操作-删除', 1, 1, 0, '', '', 38, 30, 1461550835, 1, 0);
INSERT INTO `auth_rule` VALUES (170, 'Ad/add', '操作-添加', 1, 1, 0, '', '', 45, 1, 1461550835, 1, 0);
INSERT INTO `auth_rule` VALUES (171, 'Ad/edit', '操作-修改', 1, 1, 0, '', '', 45, 2, 1461550835, 1, 0);
INSERT INTO `auth_rule` VALUES (173, 'Ad/del', '操作-删除', 1, 1, 0, '', '', 45, 5, 1461550835, 1, 0);
INSERT INTO `auth_rule` VALUES (174, 'Ad/adOrder', '操作-排序', 1, 1, 0, '', '', 45, 4, 1461550835, 1, 0);
INSERT INTO `auth_rule` VALUES (175, 'Ad/editState', '操作-状态', 1, 1, 0, '', '', 45, 3, 1461550835, 1, 0);
INSERT INTO `auth_rule` VALUES (176, 'Ad/addType', '操作-添加', 1, 1, 0, '', '', 46, 1, 1461550835, 1, 0);
INSERT INTO `auth_rule` VALUES (252, 'Template/edit', '操作-编辑', 1, 1, 0, '', '', 197, 3, 1497428906, 0, 0);
INSERT INTO `auth_rule` VALUES (178, 'Ad/delType', '操作-删除', 1, 1, 0, '', '', 46, 4, 1461550835, 1, 0);
INSERT INTO `auth_rule` VALUES (179, 'Ad/typeOrder', '操作-排序', 1, 1, 0, '', '', 46, 3, 1461550835, 1, 0);
INSERT INTO `auth_rule` VALUES (181, 'Auth/groupState', '操作-状态', 1, 1, 0, '', '', 17, 50, 1461834340, 1, 0);
INSERT INTO `auth_rule` VALUES (182, 'Users/groupEdit', '操作-修改', 1, 1, 0, '', '', 38, 15, 1461834780, 1, 0);
INSERT INTO `auth_rule` VALUES (183, 'Ad/editType', '操作-修改', 1, 1, 0, '', '', 46, 2, 1461834988, 1, 0);
...
INSERT INTO `auth_rule` VALUES (196, 'Template', '模版管理', 1, 1, 0, 'icon-embed2', '', 0, 7, 1481857304, 0, 1);
INSERT INTO `auth_rule` VALUES (197, 'Template/index', '模版管理', 1, 1, 0, '', '', 196, 1, 1481857540, 0, 1);
INSERT INTO `auth_rule` VALUES (198, 'Template/insert', '操作-添存', 1, 1, 0, '', '', 197, 2, 1481857587, 0, 0);
INSERT INTO `auth_rule` VALUES (202, 'Template/add', '操作-添加', 1, 1, 0, '', '', 197, 1, 1481859447, 0, 0);
INSERT INTO `auth_rule` VALUES (203, 'Debris/index', '碎片管理', 1, 1, 0, '', '', 196, 2, 1484797759, 0, 1);
INSERT INTO `auth_rule` VALUES (204, 'Debris/edit', '操作-编辑', 1, 1, 0, '', '', 203, 2, 1484797849, 0, 0);
INSERT INTO `auth_rule` VALUES (205, 'Debris/add', '操作-添加', 1, 1, 0, '', '', 203, 1, 1484797878, 0, 0);
INSERT INTO `auth_rule` VALUES (206, 'Wechat', '微信管理', 1, 1, 0, 'icon-bubbles2', '', 0, 8, 1487063570, 0, 1);
INSERT INTO `auth_rule` VALUES (207, 'Wechat/config', '公众号管理', 1, 1, 0, '', '', 206, 1, 1487063705, 0, 1);
INSERT INTO `auth_rule` VALUES (208, 'Wechat/menu', '菜单管理', 1, 1, 0, '', '', 206, 2, 1487063765, 0, 1);
INSERT INTO `auth_rule` VALUES (209, 'Wechat/materialmessage', '消息素材', 1, 1, 0, '', '', 206, 3, 1487063834, 0, 1);
INSERT INTO `auth_rule` VALUES (212, 'Wechat/weixin', '操作-设置', 1, 1, 0, '', '', 207, 1, 1487064541, 0, 0);
INSERT INTO `auth_rule` VALUES (213, 'Wechat/addMenu', '操作-添加', 1, 1, 0, '', '', 208, 1, 1487149151, 0, 0);
INSERT INTO `auth_rule` VALUES (214, 'Wechat/editText', '操作-编辑', 1, 1, 0, '', '', 209, 2, 1487233984, 0, 0);
INSERT INTO `auth_rule` VALUES (215, 'Wechat/addText', '操作-添加', 1, 1, 0, '', '', 209, 1, 1487234062, 0, 0);
INSERT INTO `auth_rule` VALUES (232, 'Database/downFile', '操作-下载', 1, 1, 0, '', '', 4, 2, 1497423744, 0, 0);
INSERT INTO `auth_rule` VALUES (235, 'Category/catUpdate', '操作-该存', 1, 1, 0, '', '', 9, 4, 1497424301, 0, 0);
...
INSERT INTO `auth_rule` VALUES (248, 'Message/delall', '操作-删除全部', 1, 1, 0, '', '', 48, 2, 1497427534, 0, 0);
INSERT INTO `auth_rule` VALUES (249, 'Link/edit', '操作-编辑', 1, 1, 0, '', '', 31, 2, 1497427694, 0, 0);
INSERT INTO `auth_rule` VALUES (250, 'Link/linkState', '操作-状态', 1, 1, 0, '', '', 31, 3, 1497427734, 0, 0);
INSERT INTO `auth_rule` VALUES (251, 'Link/del', '操作-删除', 1, 1, 0, '', '', 31, 4, 1497427780, 0, 0);
INSERT INTO `auth_rule` VALUES (253, 'Template/update', '操作-改存', 1, 1, 0, '', '', 197, 4, 1497428951, 0, 0);
INSERT INTO `auth_rule` VALUES (254, 'Template/delete', '操作-删除', 1, 1, 0, '', '', 197, 5, 1497429018, 0, 0);
INSERT INTO `auth_rule` VALUES (255, 'Template/images', '媒体文件管理', 1, 1, 0, '', '', 197, 6, 1497429157, 0, 0);
INSERT INTO `auth_rule` VALUES (256, 'Template/imgDel', '操作-文件删除', 1, 1, 0, '', '', 255, 1, 1497429217, 0, 0);
INSERT INTO `auth_rule` VALUES (257, 'Debris/del', '操作-删除', 1, 1, 0, '', '', 203, 3, 1497429416, 0, 0);
INSERT INTO `auth_rule` VALUES (258, 'Wechat/editMenu', '操作-编辑', 1, 1, 0, '', '', 208, 2, 1497429671, 0, 0);
INSERT INTO `auth_rule` VALUES (259, 'Wechat/menuOrder', '操作-排序', 1, 1, 0, '', '', 208, 3, 1497429707, 0, 0);
INSERT INTO `auth_rule` VALUES (260, 'Wechat/menuState', '操作-状态', 1, 1, 0, '', '', 208, 4, 1497429764, 0, 0);
INSERT INTO `auth_rule` VALUES (261, 'Wechat/delMenu', '操作-删除', 1, 1, 0, '', '', 208, 5, 1497429822, 0, 0);
INSERT INTO `auth_rule` VALUES (262, 'Wechat/createMenu', '操作-生成菜单', 1, 1, 0, '', '', 208, 6, 1497429886, 0, 0);
INSERT INTO `auth_rule` VALUES (263, 'Wechat/delText', '操作-删除', 1, 1, 0, '', '', 209, 3, 1497430020, 0, 0);
INSERT INTO `auth_rule` VALUES (265, 'Donation/index', '捐赠管理', 1, 1, 0, '', '', 28, 5, 1498101716, 0, 1);
INSERT INTO `auth_rule` VALUES (273, 'Wechat/replay', '回复设置', 1, 1, 0, '', '', 206, 4, 1508215988, 0, 1);
INSERT INTO `auth_rule` VALUES (267, 'Plugin/index', '插件管理', 1, 1, 0, 'icon-power-cord', '', 0, 9, 1501466560, 0, 1);
INSERT INTO `auth_rule` VALUES (269, 'Plugin/index', '第三方', 1, 1, 1, '', '', 267, 1, 1501466732, 0, 1);
INSERT INTO `auth_rule` VALUES (270, 'System/email', '邮箱配置', 1, 1, 0, '', '', 1, 2, 1502331829, 0, 1);
INSERT INTO `auth_rule` VALUES (272, 'Debris/type', '碎片分类', 1, 1, 1, '', '', 196, 3, 1504082720, 0, 1);
INSERT INTO `auth_rule` VALUES (280, 'User', '客户管理', 1, 1, 0, 'icon-user', '', 0, 50, 1572587042, NULL, 1);
INSERT INTO `auth_rule` VALUES (281, 'User/index', '客户列表', 1, 1, 0, '', '', 280, 50, 1572587227, NULL, 1);
...
CREATE TABLE `category`  (
  ...
  `catname` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `catdir` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `parentdir` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `pid` smallint(5) UNSIGNED NOT NULL DEFAULT 0,
  `moduleid` tinyint(2) UNSIGNED NOT NULL DEFAULT 0,
  `module` char(24) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `arrparentid` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `arrchildid` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  ...
  `template_list` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `template_show` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
...
CREATE TABLE `debris`  (
  ...
  `type_id` int(6) NULL DEFAULT NULL COMMENT '碎片分类ID',
  `title` varchar(120) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '标题',
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '内容',
  `addtime` int(13) NULL DEFAULT NULL COMMENT '添加时间',
  `sort` int(11) NULL DEFAULT 50 COMMENT '排序',
  `url` varchar(120) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '链接',
  `pic` varchar(120) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '图片',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of debris
-- ----------------------------
INSERT INTO `debris` VALUES (15, 1, '我们的差异化', '<p><span style=\"text-align: center;\">CLTPHP内容管理系统给您自由的模型构建权利，让您的想法通过您亲自操作实现。不要再为传统的数据库字段限制而发愁。一步删除，一步增加，您想要的，就是这一步。</span></p>', 1503293255, 1, '', '');
INSERT INTO `debris` VALUES (16, 1, '完整的建站理念', '<p><span style=\"text-align: center;\">CLTPHP可以轻松构建模型，让数据库随心而动，让内容表单随意而变。模型和栏目的绑定，是为了让前台页面能更好的为您的想法服务，让您不再为建站留下遗憾。</span></p>', 1503293273, 2, '', '');
INSERT INTO `debris` VALUES (17, 1, '简单、高效、低门槛', '<p><span style=\"text-align: center;\">CLTPHP内容管理系统，全程鼠标操作，不用手动建立数据库，不用画网站结构图，也不用打开编译器。网站后台直接</span><span style=\"text-align: center;\">编辑</span><span style=\"text-align: center;\">模版，让网站建设达到前所未有的极致简单。</span></p>', 1503293291, 3, '', '');
...
CREATE TABLE `debris_type`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(120) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `sort` int(1) NULL DEFAULT 50,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 6 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of debris_type
-- ----------------------------
INSERT INTO `debris_type` VALUES (1, '【首页】中部碎片', 1);
...
CREATE TABLE `donation`  (
  ...
  `name` varchar(120) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '用户名',
  `money` decimal(10, 2) NOT NULL DEFAULT 0.00 COMMENT '捐赠金额',
  `addtime` varchar(15) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of donation
-- ----------------------------
INSERT INTO `donation` VALUES (3, '高飞', 10.00, '1466566714');
INSERT INTO `donation` VALUES (4, '王磊', 5.50, '1466566733');
INSERT INTO `donation` VALUES (5, '一匹忧郁的狼', 11.11, '1466566780');
INSERT INTO `donation` VALUES (6, '神盾', 50.00, '1467517788');
INSERT INTO `donation` VALUES (7, '赵云的枪', 20.00, '1469582594');
INSERT INTO `donation` VALUES (8, '王@楠', 5.00, '1473155340');
INSERT INTO `donation` VALUES (9, '王宁', 10.00, '1473647377');
INSERT INTO `donation` VALUES (11, '幽鸣', 100.00, '1483080600');
INSERT INTO `donation` VALUES (12, '得水', 6.60, '1484874321');
INSERT INTO `donation` VALUES (13, '挨踢男', 50.00, '1485224098');
INSERT INTO `donation` VALUES (14, '郭强', 6.60, '1486343033');
INSERT INTO `donation` VALUES (15, '周超', 5.00, '1487570095');
INSERT INTO `donation` VALUES (16, '栖息地', 20.00, '1488507544');
INSERT INTO `donation` VALUES (17, '杨萍', 11.00, '1489368971');
INSERT INTO `donation` VALUES (18, '杨蹦蹦V587', 20.00, '1490608429');
INSERT INTO `donation` VALUES (19, '锋行天下', 20.00, '1499765536');
INSERT INTO `donation` VALUES (20, '周伟', 50.00, '1500014307');
INSERT INTO `donation` VALUES (21, '王者不荣耀', 20.00, '1500368368');
INSERT INTO `donation` VALUES (22, '老虎的虎', 5.00, '1500867256');
INSERT INTO `donation` VALUES (23, '老夫子', 20.00, '1501203253');
INSERT INTO `donation` VALUES (24, '我是传奇', 20.00, '1501567608');
INSERT INTO `donation` VALUES (25, '秋心', 10.00, '1501807989');
INSERT INTO `donation` VALUES (31, '晓强', 20.00, '1506742161');
INSERT INTO `donation` VALUES (32, '再向南飞', 20.00, '1507266070');
INSERT INTO `donation` VALUES (33, '女王大人', 300.00, '1508807674');
INSERT INTO `donation` VALUES (34, '在路上', 18.88, '1508851175');
INSERT INTO `donation` VALUES (35, '玉望灬', 3.00, '1509091826');
INSERT INTO `donation` VALUES (36, '诚 ', 40.00, '1510121131');
...
CREATE TABLE `download`  (
  ...
  `title_style` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `thumb` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `keywords` varchar(120) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `description` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  ...
  `updatetime` int(11) UNSIGNED NOT NULL DEFAULT 0,
  `files` varchar(80) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `ext` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'zip',
  `size` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
...
-- Records of download
-- ----------------------------
INSERT INTO `download` VALUES (3, 14, 1, 'admin', '测试下载一', 'color:;font-weight:normal;', '', '测试下载一', '测试下载一', '请输入……', '0', 0, 1, 0, '', 0, 0, 0, 1529637588, 0, '/uploads/20180622/a6f6381d3bf0f0814790ad4b5b121794.zip', 'zip', '', 0);
INSERT INTO `download` VALUES (4, 14, 1, 'admin', '测试下载二', 'color:;font-weight:normal;', '', '测试下载二', '测试下载二', '请输入……', '0', 2, 1, 0, '', 0, 0, 0, 1529638055, 1534820130, '/uploads/20180803/d834d080f9c0080abaf9a7578ceea915.zip', 'zip', '', 0);
...
CREATE TABLE `feast`  (
  ...
  `title` varchar(120) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '标题',
  `open` int(1) NULL DEFAULT 1 COMMENT '是否开启',
  `sort` int(4) NULL DEFAULT 50 COMMENT '排序',
  `addtime` varchar(15) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '添加时间',
  `feast_date` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '节日日期',
  `type` int(1) NULL DEFAULT 1 COMMENT '1阳历 2农历',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '节日列表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of feast
-- ----------------------------
INSERT INTO `feast` VALUES (2, '圣诞节', 1, 50, '1513304012', '12-25', 1);
INSERT INTO `feast` VALUES (3, '中秋节', 1, 2, '1513317857', '07-12', 1);
INSERT INTO `feast` VALUES (4, '七夕', 1, 50, '1532420762', '07-24', 1);
...
CREATE TABLE `feast_element`  (
  ...
  `title` varchar(120) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '标题',
  `css` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT 'CSS',
  `js` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT 'JS',
  `sort` int(5) NULL DEFAULT 50 COMMENT '排序',
  `open` int(1) NULL DEFAULT 1 COMMENT '是否开启',
  `addtime` varchar(15) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '节日元素表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of feast_element
-- ----------------------------
...
-- ----------------------------
-- Table structure for host_bedroom
-- ----------------------------
DROP TABLE IF EXISTS `host_bedroom`;
CREATE TABLE `host_bedroom`  (
  `host_bedroom_id` int(11) NULL DEFAULT NULL COMMENT '寄宿家庭卧室id',
  `bedroom_ceng` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '几层',
  `bedroom_money` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '价钱'
) ENGINE = MyISAM CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '卧室表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for host_child
-- ----------------------------
DROP TABLE IF EXISTS `host_child`;
CREATE TABLE `host_child`  (
  `host_child_id` int(11) NOT NULL COMMENT '寄宿家庭孩子表id',
  `hosts_id` int(11) NULL DEFAULT NULL COMMENT '寄宿家庭id',
  `child_first` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '孩子姓',
  `child_last` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '孩子名',
  `child_sex` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '孩子性别',
  `child_age` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '孩子年龄',
  PRIMARY KEY (`host_child_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '寄宿家庭孩子表' ROW_FORMAT = Compact;

-- ----------------------------
-- Table structure for host_hostrecord_id
-- ----------------------------
DROP TABLE IF EXISTS `host_hostrecord_id`;
CREATE TABLE `host_hostrecord_id`  (
  `host_hostrecord_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '寄宿家庭入住记录id',
  `student_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '学生姓名',
  `hostrecord_time` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '入住时间',
  `host_record` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '沟通记录',
  `student_feedback` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '学生反馈',
  `feedback_img` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '反馈照片',
  `student_evaluate` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '学生评价',
  PRIMARY KEY (`host_hostrecord_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '寄宿家庭入住记录表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for host_hosts
-- ----------------------------
DROP TABLE IF EXISTS `host_hosts`;
CREATE TABLE `host_hosts`  (
  `host_hosts_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '寄宿家庭id',
  `host_first` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '主人姓',
  `host_last` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '主人名',
  `host_sex` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '主人性别',
  `host_age` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '年龄(出生日期)',
  `state_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '所在州(关联州表)',
  `city` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '城市（填写城市名称）',
  `host_site_one` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '住家详细地址1',
  `host_site_two` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '住家详细地址2',
  `host_phone_one` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '主人电话1',
  `host_phone_two` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '主人电话2',
  `host_mail` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '主人电子邮件地址',
  `zip_code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '邮编',
  `host_WhatsApp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'WhatsApp账号',
  `host_race` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '主人种族（1.）',
  `host_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '主人在美居留状态',
  `host_live_time` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '主人在美生活年限',
  `host_education_background` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '主人学历',
  `host_academy` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '主人最后毕业院校名称',
  `host_faith` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '宗教信仰',
  `host_occupation` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '目前的职业/从事领域',
  `host_English_level` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '英语水平',
  `first_language` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '家中第一语言(如有)',
  `second_language` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '家中第二语言(如有)',
  `host_student_num` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '之前接待过几名学生',
  `expectation_student_sex` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '期望学生的性别',
  `student_start` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '期望学生开始年级。',
  `student_end` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '期望学生结束的年级。',
  `marital_status` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '婚姻状况？',
  `Housing_types` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '房屋类型（1.）',
  `house_ownership` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '房屋的所有权',
  `total_bedroom_num` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '卧室总数量',
  `total_toilet_num` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '卫生间总数量',
  `student_bedroom_num` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '当前可接待的学生的卧室数量',
  `automobile_num` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '汽车的数量',
  `share_independent_der` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '共用浴室，由谁共用?',
  `House_prices` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '未来3年内有搬家或出售房子的计划吗?-》你出售房屋的预期价格是多少？',
  `host_interest` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '自己和家人的爱好和兴趣',
  `is_pick_up` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '是否提供接送？',
  `host_introduce` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '关于您自己和您家人的其他介绍',
  `is_independent_toilet` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '能否提供独立卫浴',
  `is_wifi` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '是否有无线网',
  `cw` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '是否有宠物--》有几只',
  `is_meals` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '是否提供餐食',
  `is_washing` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '是否提供洗衣机',
  `is_share` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '是否共享资料给我们网站进行使用用户协议',
  `is_authenticity` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '提供的信息是否真实-用户协议',
  `channel` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '来源',
  PRIMARY KEY (`host_hosts_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '寄宿家庭表' ROW_FORMAT = Compact;

-- ----------------------------
-- Table structure for host_hostupdate_record
-- ----------------------------
DROP TABLE IF EXISTS `host_hostupdate_record`;
CREATE TABLE `host_hostupdate_record`  (
  `host_hostupdate_record_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '寄宿家庭跟进记录表id',
  `host_hostupdate_record_time` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '寄宿家庭更新时间',
  `host_hostupdate_record_describe` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '寄宿家庭更新记录',
  `host_hostupdate_record_userid` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '寄宿家庭更新人',
  PRIMARY KEY (`host_hostupdate_record_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '寄宿家庭跟进记录表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for host_img
-- ----------------------------
DROP TABLE IF EXISTS `host_img`;
CREATE TABLE `host_img`  (
  `host_img_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '住家照片id',
  `img_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '住家照片地址',
  `img_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '住家类型',
  PRIMARY KEY (`host_img_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '寄宿家庭照片表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for host_mate
-- ----------------------------
DROP TABLE IF EXISTS `host_mate`;
CREATE TABLE `host_mate`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '寄宿家庭配偶表id',
  `mate_hosts` int(255) NULL DEFAULT NULL COMMENT '寄宿家庭id',
  `mate_first` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '配偶姓',
  `mate_last` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '配偶名',
  `mate_sex` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '配偶性别',
  `mate_site` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '配偶住址',
  `mate_time` datetime NULL DEFAULT NULL COMMENT '出生日期',
  `mate_race` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '需要种族',
  `mate_legal_status` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '法定身份',
  `mate_edu_back` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '配偶学历',
  `mate_academy` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '配偶毕业院校',
  `mate_level_english` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '英语水平',
  `mate_zj` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '配偶宗教',
  `mate_zhiye` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '配偶职业',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '寄宿家庭配偶信息表' ROW_FORMAT = Compact;

-- ----------------------------
-- Table structure for host_pet
-- ----------------------------
DROP TABLE IF EXISTS `host_pet`;
CREATE TABLE `host_pet`  (
  `host_pet_id` int(11) NOT NULL COMMENT '宠物id',
  `host_pet_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`host_pet_id`) USING BTREE
) ENGINE = MyISAM CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '宠物表\r\n' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for host_school
-- ----------------------------
DROP TABLE IF EXISTS `host_school`;
CREATE TABLE `host_school`  (
  `host_school_id` int(255) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '院校id',
  `school_zh_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '院校中文名称',
  `school_en_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '院校英文',
  `school_longitude` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '经度',
  `school_latitude` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '纬度',
  `state_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '所在州id',
  `school_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '状态',
  `school_addtime` datetime NULL DEFAULT NULL COMMENT '院校添加时间',
  PRIMARY KEY (`host_school_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '寄宿院校表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for host_state
-- ----------------------------
DROP TABLE IF EXISTS `host_state`;
CREATE TABLE `host_state`  (
  `host_state_id` int(11) NULL DEFAULT NULL COMMENT '寄宿家庭州id',
  `state_zh_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '州中文名',
  `state_en_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '州英文名'
) ENGINE = MyISAM CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '寄宿家庭州表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for host_user
-- ----------------------------
DROP TABLE IF EXISTS `host_user`;
CREATE TABLE `host_user`  (
  `host_user_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '寄宿家庭用户id',
  `user_sex` tinyint(3) UNSIGNED NOT NULL DEFAULT 1 COMMENT '用户性别（1.男 2.女）',
  `birth_date` int(10) UNSIGNED NOT NULL COMMENT '用户出生日期',
  `school_address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '学校地址',
  `school_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '学校名称',
  `grade_Enrolled` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '入读年级',
  `the_date` int(10) UNSIGNED NOT NULL COMMENT '入读日期',
  `Check_deadlines` tinyint(4) UNSIGNED NOT NULL COMMENT '入住期限(1. 3个月 2. 6个月 3. 12个月)',
  `host_tyle` tinyint(4) UNSIGNED NOT NULL COMMENT '寄宿家庭类型要求(1.华人 2.美国 3.无所谓)',
  `special_requirements` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '无特殊要求' COMMENT '其它特殊要求',
  `add_time` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '表单提交时间',
  `ip` int(255) UNSIGNED NOT NULL COMMENT '提交ip',
  PRIMARY KEY (`host_user_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '寄宿家庭用户表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `link`  (
  ...
  `title` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '链接名称',
  `url` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '链接URL',
  `type_id` tinyint(4) NULL DEFAULT NULL COMMENT '所属栏目ID',
  `qq` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '联系QQ',
...
-- Records of link
-- ----------------------------
INSERT INTO `link` VALUES (10, 'CLTPHP', 'http://www.cltphp.com/', 0, '1109305987', 1, 1495183645, 1);
INSERT INTO `link` VALUES (8, 'CLTPHP内容管理系统', 'http://www.cltphp.com/', 0, '1109305987', 2, 1484791374, 1);
INSERT INTO `link` VALUES (11, 'CLTPHP动态', 'http://www.cltphp.com/news-49.html', 0, '', 3, 1499765975, 1);
INSERT INTO `link` VALUES (12, '关于我们', 'http://cltphp.com/about-8.html', 0, '', 4, 1499766009, 1);
INSERT INTO `link` VALUES (13, 'CLTPHP相关知识', 'http://cltphp.com/news-51.html', 0, '', 5, 1499766031, 1);
...
CREATE TABLE `message`  (
  ...
  `title` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '留言标题',
  `tel` varchar(15) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '留言电话',
  `addtime` varchar(15) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '留言时间',
  `open` tinyint(2) NOT NULL DEFAULT 0 COMMENT '1=审核 0=不审核',
  `ip` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '留言者IP',
  `content` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '留言内容',
  `name` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '用户名',
  `email` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '留言邮箱',
...
-- Records of message
-- ----------------------------
INSERT INTO `message` VALUES (92, '呵呵', '', '1528851199', 0, '127.0.0.1', '为什么还不更新？', 'chichu', '1109305987@qq.com');
INSERT INTO `message` VALUES (93, '11', '', '1530629400', 0, '127.0.0.1', '11', '11', '11');
INSERT INTO `message` VALUES (94, '11', '', '1530777448', 0, '127.0.0.1', '11', '11', '11');
INSERT INTO `message` VALUES (95, '11', '', '1542781283', 0, '127.0.0.1', '<p>111</p>', '11', '110@qq.com');
...
CREATE TABLE `module`  (
  ...
  `type` tinyint(1) UNSIGNED NOT NULL DEFAULT 0,
  `issystem` tinyint(1) UNSIGNED NOT NULL DEFAULT 0,
  `listfields` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
...
CREATE TABLE `oauth`  (
  ...
  `type` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '账号类型',
  `openid` varchar(120) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '第三方唯一标示',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `page`  (
  ...
  `lang` tinyint(1) UNSIGNED NOT NULL DEFAULT 0,
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '内容',
  `template` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `picture`  (
  ...
  `createtime` int(11) UNSIGNED NOT NULL DEFAULT 0,
  `updatetime` int(11) UNSIGNED NOT NULL DEFAULT 0,
  `pic` varchar(80) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
...
-- Records of picture
-- ----------------------------
INSERT INTO `picture` VALUES (1, 4, 1, 'admin', '模型列表', '模型列表', '展示网站内容模型，模型是CLTPHP的核心之一。', '<p>展示网站内容模型，模型是CLTPHP的核心之一。</p>', '0', 0, 1, 0, '', 0, 1, 1, 1499761915, 1528699234, '/uploads/20180611/0ce39ef421e7ca7149b2630d93b571ee.png', '1');
INSERT INTO `picture` VALUES (2, 4, 1, 'admin', '添加模型', '添加模型', '添加模型', '<p>您可以通过后台轻松创建新的新的模型，不拘泥于传统。</p>', '0', 0, 1, 0, '', 0, 2, 0, 1499762188, 1528699288, '/uploads/20180611/e41226ad6f977aeb2418a0f55a0678ef.png', '1');
INSERT INTO `picture` VALUES (3, 4, 1, 'admin', '模型字段', '模型字段', '模型字段', '<p>您可以任意构建自己的模型字段，从而达到网站内容的高效编辑。</p>', '0', 0, 1, 0, '', 0, 3, 0, 1499762270, 1528699324, '/uploads/20180611/57027c6ab845effea600f6f9695e2db4.png', '1');
INSERT INTO `picture` VALUES (4, 4, 1, 'admin', '添加字段', '添加字段', '添加字段', '<p>CLTPHP提供了丰富的字段类型，当然您可以扩展出更多的类型。</p>', '0', 0, 1, 0, '', 0, 4, 0, 1499762323, 1528699410, '/uploads/20180611/85f128c3c9488a41b04386e31199ab3f.png', '1');
INSERT INTO `picture` VALUES (5, 4, 1, 'admin', '栏目列表', '栏目列表', '栏目列表', '<p>栏目编辑，可以让后台编辑明确，也可以使的前台展示更加分明。</p>', '0', 0, 1, 0, '', 0, 5, 0, 1499762369, 1528699472, '/uploads/20180611/2b6456d6725ce4ad1a8dd66b595f1eb9.png', '2');
INSERT INTO `picture` VALUES (6, 4, 1, 'admin', '添加栏目', '添加栏目', '添加栏目', '<p>添加栏目时绑定模型，以适应网站内容的多样性。</p>', '0', 0, 1, 0, '', 0, 6, 0, 1499762446, 1528699568, '/uploads/20180611/953235f4e44df6dd63de15bb28ea0bc5.png', '2');
INSERT INTO `picture` VALUES (7, 4, 1, 'admin', '内容列表', '内容列表', '内容列表', '<p>点击栏目名称进入对应的内容列表页，简洁而高效。</p>', '0', 0, 1, 0, '', 0, 7, 0, 1499762523, 1528699605, '/uploads/20180611/fb3193674fb2ea68f2a61d4de0859a0e.png', '3');
INSERT INTO `picture` VALUES (8, 4, 1, 'admin', '添加内容', '添加内容', '添加内容', '<p>不同栏目的内容编辑页是根据及绑定的模型智能生成的。</p>', '0', 0, 1, 0, '', 0, 8, 0, 1499762754, 1528699629, '/uploads/20180611/ef322c904a47681d32aa4338316bac18.png', '3');
...
CREATE TABLE `product`  (
  ...
  `xinghao` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `pics` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `status`(`id`, `status`, `sort`) USING BTREE,
  INDEX `catid`(`id`, `catid`, `status`) USING BTREE,
  INDEX `listorder`(`id`, `catid`, `status`, `sort`) USING BTREE
...
CREATE TABLE `region`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3410 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `role_user`  (
  `role_id` mediumint(9) UNSIGNED NULL DEFAULT 0,
  `user_id` char(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '0',
...
CREATE TABLE `system`  (
  ...
  `name` char(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '网站名称',
  `domain` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '网址',
  ...
  `bah` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备案号',
  `copyright` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'copyright',
  `ads` varchar(120) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '公司地址',
  `tel` varchar(15) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '公司电话',
  ...
  `mobile` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT 'open' COMMENT '是否开启手机端 open 开启 close 关闭',
  `code` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT 'close' COMMENT '是否开启验证码',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `tags`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '标签名称',
  `nums` int(11) NULL DEFAULT 0 COMMENT '适配数',
...
-- Records of tags
-- ----------------------------
INSERT INTO `tags` VALUES (1, 'cltphp', 2, 5);
INSERT INTO `tags` VALUES (2, '时间', 1, 4);
INSERT INTO `tags` VALUES (3, 'CLTPHP', 1, 1);
INSERT INTO `tags` VALUES (4, '更新', 1, 0);
INSERT INTO `tags` VALUES (5, 'CSS', 1, 0);
INSERT INTO `tags` VALUES (6, '邮箱验证', 1, 0);
INSERT INTO `tags` VALUES (7, 'PC端', 1, 0);
INSERT INTO `tags` VALUES (8, '手机端', 1, 0);
...
-- Records of team
-- ----------------------------
INSERT INTO `team` VALUES (1, '快乐的毛豆豆—前端工程师', 'color:rgb(57, 61, 73);font-weight:normal;', '/uploads/20180613/27f4cfe5854eb4cfdfd87399a60c7cbd.jpg', 0, 1, 1, 'admin', 0, 1499764958, 1528876606, 0, 7, '<p>2年设计、3年前端，从菜鸟到老手，从未停止追求细节的完美。注重细节，追求完美已成为习惯。</p>', NULL);
INSERT INTO `team` VALUES (2, '褫憷—软件工程师', 'color:rgb(57, 61, 73);font-weight:normal;', '/uploads/20180613/7d4aaaf4c86aac002184dace64cf179e.jpg', 1, 1, 1, 'admin', 0, 1499765015, 1528876594, 0, 7, '<p>5年开发、3年前端，不断的自我建设，来保持向上的状态。</p>', NULL);
...
CREATE TABLE `user_level`  (
  ...
  `bomlimit` int(5) NULL DEFAULT 0 COMMENT '积分下限',
  `toplimit` int(5) NULL DEFAULT 0 COMMENT '积分上限',
...
-- ----------------------------
INSERT INTO `user_level` VALUES (1, '注册会员', 1, 0, 500);
INSERT INTO `user_level` VALUES (2, '铜牌会员', 2, 501, 1000);
INSERT INTO `user_level` VALUES (3, '白银会员', 3, 1001, 2000);
INSERT INTO `user_level` VALUES (4, '黄金会员', 4, 2001, 3500);
INSERT INTO `user_level` VALUES (5, '钻石会员', 5, 3501, 5500);
INSERT INTO `user_level` VALUES (6, '超级VIP', 6, 5500, 99999);
...
CREATE TABLE `users`  (
  ...
  `paypwd` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '支付密码',
  ...
  `username` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '第三方返回昵称',
  ...
  `status` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT 'hide' COMMENT '登录状态',
  PRIMARY KEY (`id`) USING BTREE,
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES (1, '1109305987@qq.com', '', NULL, 1, 0, 1516075631, 0, '', '', '44311', 0, '', NULL, NULL, '/uploads/20180613/fcb729987d8e9339bd9b2e85c85f3028.jpg', 24, 311, 2599, 0, 'chichu', 1, 0, '', '不要应为走得太远，就忘了当初为什么出发！', 'hide');
INSERT INTO `users` VALUES (2, '', 'e10adc3949ba59abbe56e057f20f883e', NULL, 0, 0, 1542781390, 0, '', '', '18092591522', 1, '', NULL, NULL, NULL, 0, 0, 0, 0, 'chichu', 1, 0, '', '', 'hide');
...
CREATE TABLE `wx_default_replay`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 AVG_ROW_LENGTH = 16384 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '关注时回复' ROW_FORMAT = Compact;
...
CREATE TABLE `wx_follow_replay`  (
  ...
  `modify_time` int(11) NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 AVG_ROW_LENGTH = 16384 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '关注时回复' ROW_FORMAT = Compact;
...
CREATE TABLE `wx_key_replay`  (
  ...
  `modify_time` int(11) NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 AVG_ROW_LENGTH = 16384 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '关键词回复' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of wx_key_replay
-- ----------------------------
INSERT INTO `wx_key_replay` VALUES (2, 0, '你好', 1, 3, 0, 1528696514, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 7 AVG_ROW_LENGTH = 1170 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
INSERT INTO `wx_media` VALUES (4, 'CLTPHP内容管理系统5.2.2发布', 0, '3', 0, 1528694363, 0);
INSERT INTO `wx_media` VALUES (5, 'CLTPHP操作开发手册已完全更新', 0, '2', 0, 1528694392, 0);
INSERT INTO `wx_media` VALUES (6, '1111', 0, '1', 0, 1528694379, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 52 AVG_ROW_LENGTH = 712 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 5 AVG_ROW_LENGTH = 1638 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '微设置->微店菜单' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of wx_menu
-- ----------------------------
INSERT INTO `wx_menu` VALUES (1, 0, '官网', '', 0, 2, 3, 'http://www.cltphp.com/', 0, 1, 1512442512, 0);
INSERT INTO `wx_menu` VALUES (2, 0, '手册', '', 0, 2, 5, 'http://www.cltphp.com/', 0, 2, 1512442543, 0);
INSERT INTO `wx_menu` VALUES (3, 0, '论坛', '', 0, 1, 4, 'http://bbs.cltphp.com/', 0, 3, 1512547727, 0);
INSERT INTO `wx_menu` VALUES (4, 0, '百度', '', 3, 1, 0, 'http://www.baodu.com', 0, 1, 1542783759, 0);
...
CREATE TABLE `wx_mp`  (
  ...
  `qrcode` varchar(120) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '二维码',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 AVG_ROW_LENGTH = 963 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '第三方配置表' ROW_FORMAT = Compact;
...
INSERT INTO `wx_mp` VALUES (2, 0, 'SHOPWCHAT', '{\"appid\":\"wxeb0f7505d1316648\",\"appsecret\":\"e5147ce07128asdfds222f628b5c3fe1af2ea5797\",\"token\":\"dffdf\",\"qrcode\":\"\\/uploads\\/20191025\\/c915cbc4605a9aae9e98764e707bbd20.jpg\",\"file\":\"\"}', '', 1, 1497088090, 1571988788, '/uploads/20191025/c915cbc4605a9aae9e98764e707bbd20.jpg');
...
CREATE TABLE `wx_user`  (
  ...
  `concern` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '关注回复',
  `default` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '默认回复',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `uid`(`uid`) USING BTREE,
  INDEX `uid_2`(`uid`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '微信公共帐号' ROW_FORMAT = Dynamic;
