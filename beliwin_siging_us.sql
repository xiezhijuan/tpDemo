...
Source Database       : beliwin_siging_us

Target Server Type    : MYSQL
Target Server Version : 50553
File Encoding         : 65001

Date: 2020-04-09 13:24:27
*/
...
INSERT INTO `admin` VALUES ('13', 'teacher1', 'e10adc3949ba59abbe56e057f20f883e', '2', 'fanyitaosun@163.com', null, '17611322825', '127.0.0.1', '1579414246', '0', '1', '/uploads/20200119/8b94b9ace0fe701bf6d4618c69fe1148.png', null);
...
) ENGINE=MyISAM AUTO_INCREMENT=436 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='权限节点';
...
INSERT INTO `auth_rule` VALUES ('345', 'Sysmodule', '系统权限2.0', '1', '1', '0', '', '', '0', '2', '1578382768', null, '1');
...
INSERT INTO `auth_rule` VALUES ('377', 'Sysview', '关联管理', '1', '1', '0', '', '', '0', '1', '1578994607', null, '1');
...
-- ----------------------------
-- Table structure for cs_ban
-- ----------------------------
DROP TABLE IF EXISTS `cs_ban`;
CREATE TABLE `cs_ban` (
  `ban_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `ban_name` varchar(100) NOT NULL DEFAULT '默认' COMMENT '班级名称',
  `ban_des` varchar(100) NOT NULL DEFAULT '默认' COMMENT '班级简介',
  `ban_sort` varchar(100) NOT NULL DEFAULT '默认' COMMENT '班级排序',
  `ban_num` varchar(100) NOT NULL DEFAULT '默认' COMMENT '班级人数',
  `ban_status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '班级状态',
  PRIMARY KEY (`ban_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='班级表';
...
CREATE TABLE `cs_student` (
  ...
  `student_name` varchar(100) NOT NULL DEFAULT '默认' COMMENT '学生名称',
  `student_sex` tinyint(1) NOT NULL DEFAULT '0' COMMENT '学生性别',
  `student_ban_id` varchar(100) NOT NULL COMMENT '所属班级',
  `student_teacher_id` varchar(100) DEFAULT NULL COMMENT '老师id',
  PRIMARY KEY (`student_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='学生表';

-- ----------------------------
-- Records of cs_student
-- ----------------------------
INSERT INTO `cs_student` VALUES ('2', '1', '1', '', '2');
INSERT INTO `cs_student` VALUES ('3', '2', '1', '', '2');
INSERT INTO `cs_student` VALUES ('4', '111', '1', '', '1');
INSERT INTO `cs_student` VALUES ('5', '22222', '2', '', '1');
...
CREATE TABLE `cs_teacher` (
  ...
  `teacher_name` varchar(100) NOT NULL DEFAULT '默认' COMMENT '老师姓名',
  `teacher_status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '老师状态',
  `teacher_type` varchar(50) NOT NULL DEFAULT '' COMMENT '授课类型',
  PRIMARY KEY (`teacher_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='老师表';

-- ----------------------------
-- Records of cs_teacher
-- ----------------------------
INSERT INTO `cs_teacher` VALUES ('1', '1', '1', '2');
INSERT INTO `cs_teacher` VALUES ('2', '2', '1', '2');
